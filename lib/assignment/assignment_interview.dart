            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: const Text('Type of Crop', style: TextStyle(fontSize: 14)),
                ),
                SizedBox(height: 8),
                Container(
                  height: 40,
                ...
                const Text('Price (per Kg)', style: TextStyle(fontSize: 14)),              SizedBox(height: 8),
                                    ...
                                    child: Stack(
                                      children: [
                                        ClipRRect(
                                          child: Image(
                                            image:
                                                AssetImage('assets/pic two.webp'),
                                          ),
                                          borderRadius: BorderRadius.circular(7),
                                        ),
                                        // Assuming you want to conditionally show either an Icon or a File image
                ...
                Padding(
                  padding: const EdgeInsets.only(
                      left: 4, right: 4, top: 100, bottom: 15),
                  child: InkWell(
                    onTap: () {},
                    child: Container(
                      height: 40,
